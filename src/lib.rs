...
mod tests {
    ...
    fn test_url_parsing() {
        ...
        let url = UrlParser::url("ftp://naver.com:20/path/sdf/?query=sdfasdsdfs@34");
        assert_eq!("ftp://naver.com:20/path/sdf/?query=sdfasdsdfs@34",url.get_url());
        assert_eq!("ftp",url.protocol());
        ...
        let url = UrlParser::url("https://naver.com:80/path/sdf/?query=sdfasdsdfs@34");
        ...
        assert_eq!("query=sdfasdsdfs@34",url.query());
        //protocol parsing
        let url = UrlParser::url("www.naver.com:80/path/sdf/?query=sdfasdsdfs@34");
        assert_eq!("www.naver.com:80/path/sdf/?query=sdfasdsdfs@34",url.get_url());
        assert_eq!("https",url.protocol()); //cuz default https
        ...
        let url = UrlParser::url("https://naver.com/path/sdf/?query=sdfasdsdfs@34");
        ...
        let url = UrlParser::url("naver.com/?query=sdfasdsdfs@34");
        ...
        let url = UrlParser::url("naver.com/path/sdrfd/rre/");
        ...
        let url = UrlParser::url("naver.com/");
